...
<div id="main" class="main-container">
    ...
    <div class="box">
        ...
        <form action="{{ URL::to('register') }}" method="post">
            @csrf
            <div class="input-box">
                <input id="user-name" type="text" name="name" class="@error('name') is-invalid @enderror"
                    value="{{ old('name') }}">
                <label>Name</label>
                @error('name')
            ...
            <div class="input-box">
                <input id="user-pass" type="password" name="password" class="@error('password') is-invalid @enderror">
        ...
        <p>Already have an account ? <a href="{{URL::to('login')}}" class="text-info">Login</a></p>
    </div>
</div>
</div>
</div>
