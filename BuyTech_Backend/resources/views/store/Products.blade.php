        ...
        <div class="col-12">
            <div class="card card-default card-md mb-4">
                <div class="card-header">
                    <h6>Products</h6>
                    <a class="btn btn-primary" href="{{ URL::to('store/Products/add') }}" role="button">Add New </a>
                </div>
                <div class="card-body">
                                    ...
                                    @if (!empty($data))
                                        ...
                                        @if($value->userId == Auth::user()->id)
                                            <tr class="draggable" draggable="true">
                                                ...
                                                <td>
                                                    <div>
                                                        <a href="{{ URL::to('store/Products/add', $value->id) }}">
                                                            <img class="svg"
                                                                src="{{ URL::to('public/backend/img/svg/edit.svg') }}"
                                                                alt="edit">
                                                        </a>
                                                        <a href="{{ URL::to('store/Products/remove', $value->id) }}">
                                                            <img class="svg"
